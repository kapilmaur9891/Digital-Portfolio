    ...
    <div class="mobile-nav">
        ...
        <ul> 
            <img src="images\adivinar3.png" alt="" id="mobile-image"> <hr> 
             <li> <?php $name = $_SESSION['username']; echo $name; ?></li>
             <li><a href="#">Home</a></li>
        ...
        <header id="home">
            <div class="container">
                <nav id="main-nav" class="flexbox items-center justify-between">
                    ...
                    <div class="right flexbox">
                        ...
                        <a><?php $name = $_SESSION['username']; echo $name; ?></a>
            ...
            <form class="rate-two">
                ...
                <label for="s5"></label>
                            ...
                            <a href="resume.php?file=./images/CV" target="_blank"><button class="btn btn-first">Download CV</button></a>
                        </div>
